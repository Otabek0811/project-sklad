...
func (h *handler) CreateProduct(c *gin.Context) {
	...
	h.handlerResponse(c, "create product response", http.StatusCreated, resp)
}
...
func (h *handler) GetByIdProduct(c *gin.Context) {
	...
	h.handlerResponse(c, "get by id product response", http.StatusOK, resp)
}
...
// @Param search_by_name query string false "search"
// @Param search_by_barcode query string false "search"
// @Success 200 {object} Response{data=string} "Success Request"
// @Response 400 {object} Response{data=string} "Bad Request"
// @Failure 500 {object} Response{data=string} "Server error"
...
func (h *handler) UpdateProduct(c *gin.Context) {
	...
	h.handlerResponse(c, "create product response", http.StatusAccepted, resp)
}
...
func (h *handler) DeleteProduct(c *gin.Context) {
	...
	h.handlerResponse(c, "delete product response", http.StatusAccepted, nil)
}
